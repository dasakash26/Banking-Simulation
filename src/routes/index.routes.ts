...
import { createUser, getAllUsers, getUserByPAN } from "../controllers/user.controller";
...
import { earn, spend, salaryCycle, simulate, revenueGen, simulateMonthlyExpenses,  } from "../controllers/simulation.controller";
...
router.post("/simulate/salary-cycle", salaryCycle);
